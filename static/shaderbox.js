...
class Shaderbox extends HTMLElement {
    constructor() {
        ...
        css.setAttribute("href", `${shaderboxScriptSrc}/../shaderbox.css`);
        this.shadow.appendChild(css);

        // this.formSlot = document.createElement("slot");
        // this.formSlot.name = "controls-form";
        // debugger;

        if (this.firstElementChild) this.shadow.appendChild(this.firstElementChild);
        this.instantiateShader();
    }
    ...
    instantiateShader() {
        /* =========================================================================
           ...
           ========================================================================= */
        const SHADER_NAME = this.getAttribute("shader");
        const SHADER_DIR = `${SHADER_NAME}`;
        const SHADER_ID = this.getAttribute("id") || undefined;
        ...
        if (!controlForm) {
            controlForm = this.shadow.querySelector(`form`);
        }
        ...
        this.shadow.appendChild(errBox);
...
customElements.define("shader-box", Shaderbox, {} );
